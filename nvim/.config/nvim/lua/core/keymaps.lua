...
-- Yazi-nvim
keymap.set("n", "<leader>-", ":Yazi<CR>") --Opens Yazi at the current file
keymap.set("n", "<leader>-", ":Yazi cwd<CR>") --Opens Yazi at the current working directory 
keymap.set("n", "<leader>-", ":Yazi toggle<CR>") --Opens the last Yazi session 
...
-- Vimwiki
keymap.set('n', '<leader>ww', '<Plug>VimwikiIndex')
keymap.set('n', '<leader>wt', '<Plug>VimwikiTabIndex')
keymap.set('n', '<leader>ws', '<Plug>VimwikiUISelect')
keymap.set('n', '<leader>wi', '<Plug>VimwikiDiaryIndex')
keymap.set('n', '<leader>w<leader>w', '<Plug>VimwikiMakeDiaryNote')
keymap.set('n', '<leader>w<leader>t', '<Plug>VimwikiTabMakeDiaryNote')
